...
impl QueryRoot {
    ...
    async fn user_listening_history(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<user_listening_history::Model>, DbErr> {
        let db = ctx
    ...
    async fn challenge_profile_completion(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<challenge_profile_completion::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn chat_blocked_users(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<chat_blocked_users::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn ursm_content_nodes(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<ursm_content_nodes::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn related_artists(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<related_artists::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn chat_message_reactions(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<chat_message_reactions::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn reward_manager_txs(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<reward_manager_txs::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn alembic_version(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<alembic_version::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_playlist(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_playlist::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_daily_total_users_metrics(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_daily_total_users_metrics::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn notification_seen(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<notification_seen::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_monthly_app_name_metrics(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_monthly_app_name_metrics::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_plays(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_plays::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn rewards_manager_backfill_txs(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<rewards_manager_backfill_txs::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn indexing_checkpoints(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<indexing_checkpoints::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn user_bank_backfill_txs(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<user_bank_backfill_txs::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn skipped_transactions(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<skipped_transactions::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_daily_app_name_metrics(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_daily_app_name_metrics::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn playlist_routes(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<playlist_routes::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_monthly_total_users_metrics(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_monthly_total_users_metrics::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn user_balance_changes(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<user_balance_changes::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_daily_unique_users_metrics(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_daily_unique_users_metrics::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_track(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_track::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn hourly_play_counts(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<hourly_play_counts::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_monthly_unique_users_metrics(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_monthly_unique_users_metrics::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_monthly_plays(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_monthly_plays::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn supporter_rank_ups(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<supporter_rank_ups::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn user_bank_accounts(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<user_bank_accounts::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn audio_transactions_history(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<audio_transactions_history::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn audius_data_txs(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<audius_data_txs::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn challenge_listen_streak(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<challenge_listen_streak::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn track_trending_scores(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<track_trending_scores::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn schema_migrations(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<schema_migrations::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn app_name_metrics(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<app_name_metrics::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn chat_permissions(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<chat_permissions::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn challenge_disbursements(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<challenge_disbursements::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn associated_wallets(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<associated_wallets::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn user_challenges(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<user_challenges::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn aggregate_user_tips(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<aggregate_user_tips::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn spl_token_backfill_txs(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<spl_token_backfill_txs::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
    ...
    async fn trending_results(
        &self,
        ctx: &Context<'_>,
    ) -> Result<Vec<trending_results::Model>, DbErr> {
        let db = ctx
            .data::<DatabaseConnection>()
            .map_err(|e| DbErr::Custom(e.message))?;
